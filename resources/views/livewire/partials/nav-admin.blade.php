<div x-data="{ open: false }" class="md:sticky md:top-0 md:self-start">
    ...
    <button @click="open = !open" class="absolute top-0 right-0 p-4 text-gray-700 bg-white rounded-full ">
    ...
    <aside :class="open ? 'translate-x-0' : '-translate-x-full'"
        class="static inset-y-0 z-20 transition-transform duration-300 transform bg-white border-r shadow-md md:w-64 md:translate-x-0 md:shadow-none">
    ...
    <!-- Overlay (for mobile) -->
    <div @click="open = false" x-show="open" x-cloak class="static inset-0 bg-black bg-opacity-50 lg:hidden">
    </div>
</div>
